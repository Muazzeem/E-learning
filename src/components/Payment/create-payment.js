...
function CreatePayment() {
    ...
    function handleClick() {
        axios.post('https://api.dev.learning.fractalslab.com/crm/save-contact', data, {headers: {"Content-Type": "application/json"}}).then(
            res => {
...
//   onClick function
    ...
    return (
        <div className="payment-card mt-50 mb-50">
            ...
            <div className={`${isChecked || isOther ? "aaa" : "d-none"}`}>
